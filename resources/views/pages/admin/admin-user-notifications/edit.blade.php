...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{!! action('Admin\AdminUserNotificationController@index') !!}"><i class="fa fa-files-o"></i>
            AdminUserNotifications</a></li>
    @if( $isNew )
        <li class="breadcrumb-item active">New</li>
    @else
        <li class="breadcrumb-item active">{{ $adminUserNotification->id }}</li>
    @endif
@stop
