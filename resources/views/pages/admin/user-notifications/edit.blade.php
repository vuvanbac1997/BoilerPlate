...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{!! action('Admin\UserNotificationController@index') !!}"><i class="fa fa-files-o"></i>
            UserNotifications</a></li>
    @if( $isNew )
        <li class="breadcrumb-item active">New</li>
    @else
        <li class="breadcrumb-item active">{{ $userNotification->id }}</li>
    @endif
@stop
