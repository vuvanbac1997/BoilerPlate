...
@section('content')
    <form action="{!! action('Web\AuthController@postSignIn') !!}" method="post">
        {!! csrf_field() !!}
    ...
    <a href="{!! action('Web\PasswordController@getForgotPassword') !!}">@lang('user.pages.auth.messages.forgot_password')</a>
    <br>
@stop
