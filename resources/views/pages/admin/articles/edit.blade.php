...
@section('styles')
    <link rel="stylesheet" href="{!! \URLHelper::asset('libs/datetimepicker4/css/bootstrap-datetimepicker.min.css', 'admin') !!}">
...
@section('scripts')
    ...
    <script src="{{ \URLHelper::asset('libs/datetimepicker4/js/bootstrap-datetimepicker.min.js', 'admin') }}"></script>
...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{!! action('Admin\ArticleController@index') !!}"><i class="fa fa-files-o"></i> Articles</a></li>
    @if( $isNew )
    ...
    <form action="@if($isNew) {!! action('Admin\ArticleController@store') !!} @else {!! action('Admin\ArticleController@update', [$article->id]) !!} @endif" method="POST" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <a href="{!! URL::action('Admin\ArticleController@index') !!}" class="btn btn-block btn-secondary btn-sm" style="width: 125px; display: inline-block;">@lang('admin.pages.common.buttons.back')</a>
                    ...
                    <div class="col-lg-7">
                        <table class="edit-user-profile">
                            ...
                            <tr class="@if ($errors->has('publish_started_at')) has-error @endif">
                                ...
                                <td>
                                    <div class="input-group date datetime-field" style="margin-bottom: 10px;">
                                        <input id ="datetimepicker" type="text" class="form-control" style="margin: 0;" name="publish_started_at" required value="{{ old('publish_started_at') ? old('publish_started_at') : $article->publish_started_at }}">
                            ...
                            <tr class="@if ($errors->has('publish_ended_at')) has-error @endif">
                                ...
                                <td>
                                    <div class="input-group date datetime-field" style="margin-bottom: 10px;">
                                        <input id ="datetimepicker1" type="text" class="form-control" style="margin: 0;" name="publish_ended_at" value="{{ old('publish_ended_at') ? old('publish_ended_at') : $article->publish_ended_at }}">
                                        <div class="input-group-append">
                                            <span class="input-group-text fa fa-calendar"></span>
                                        </div>
                                    </div>
